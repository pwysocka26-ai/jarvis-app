...
def chat(req: ChatRequest) -> ChatResponse:
    ...
    elif "pokaż" in low or "pokaz" in low or "lista" in low:
        normalized = "lista"

    elif _LAST_CHAT_TASK_ID and "ważne" in low:
    ...
    if isinstance(reply, str):
        ...
        if m:
            _LAST_CHAT_TASK_ID = int(m.group(1)) if isinstance(out, dict) else ""
